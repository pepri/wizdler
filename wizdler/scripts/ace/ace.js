...
((function () {
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      ((t.useStrictCSP = function (e) {
        ...
        (t.$fixPositionBug = function (e) {
          var t = e.getBoundingClientRect();
          if (e.style.left) {
            var n = parseFloat(e.style.left),
              r = +t.left;
            Math.abs(n - r) > 1 && (e.style.left = 2 * n - r + "px");
          }
          if (e.style.right) {
            var n = parseFloat(e.style.right),
              r = window.innerWidth - t.right;
            Math.abs(n - r) > 1 && (e.style.right = 2 * n - r + "px");
          }
          if (e.style.top) {
            var n = parseFloat(e.style.top),
              r = +t.top;
            Math.abs(n - r) > 1 && (e.style.top = 2 * n - r + "px");
          }
          if (e.style.bottom) {
            var n = parseFloat(e.style.bottom),
              r = window.innerHeight - t.bottom;
            Math.abs(n - r) > 1 && (e.style.bottom = 2 * n - r + "px");
          }
        }),
    ...
    function (e, t, n) {
      var r = {
        ...
        "gutter.annotation.aria-label.hint":
          "Suggestion, read annotations row $0",
              ...
              f[e] ||
                (a(
                  "No message found for the key '" +
                    ...
                    "' in messages with id " +
                    f.$id +
                    ", trying to find a translation for the default string '" +
                    t +
                    "'.",
                ),
                f[t] ||
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      for (var o = 0; o < 10; o++)
        ((s["Digit" + o] = 48 + o),
          (s["Numpad" + o] = 96 + o),
          (i.PRINTABLE_KEYS[48 + o] = "" + o),
          (i.FUNCTION_KEYS[96 + o] = "Numpad" + o));
      for (var o = 65; o < 91; o++) {
        var u = String.fromCharCode(o + 32);
        ((s["Key" + u.toUpperCase()] = o), (i.PRINTABLE_KEYS[o] = u));
      }
      for (var o = 1; o < 13; o++)
        ((s["F" + o] = 111 + o), (i.FUNCTION_KEYS[111 + o] = "F" + o));
      var a = { Shift: 16, Control: 17, Alt: 18, Meta: 224 };
      ...
      (r.mixin(i, i.MODIFIER_KEYS),
        r.mixin(i, i.PRINTABLE_KEYS),
        ...
        (function () {
          ...
          for (var t = Math.pow(2, e.length); t--; )
            i.KEY_MODS[t] =
              e
                .filter(function (e) {
      ...
      var r = e("../lib/event"),
        ...
        y = (function () {
          function e(e, t) {
            var n = this;
            ((this.host = t),
              (this.text = o.createElement("textarea")),
              ...
              e.insertBefore(this.text, e.firstChild),
              (this.copied = !1),
              (this.pasted = !1),
              (this.inComposition = !1),
              (this.sendingText = !1),
              (this.tempStyle = ""),
              g || (this.text.style.fontSize = "1px"),
              (this.commandMode = !1),
              (this.ignoreFocusEvents = !1),
              (this.lastValue = ""),
            ...
            ((this.cancelComposition = this.cancelComposition.bind(this)),
              ...
              r.addListener(
                ...
                "blur",
                function (e) {
                  if (n.ignoreFocusEvents) return;
                  (t.onBlur(e), (n.$isFocused = !1));
                },
                t,
              ),
              r.addListener(
                ...
                function (e) {
                  ...
                  (t.onFocus(e),
                    s.isEdge
                      ? setTimeout(n.resetSelection.bind(n))
                      : n.resetSelection());
                },
                t,
              ),
              ...
              t.on("beforeEndOperation", function () {
                ...
                (n.inComposition &&
                  i &&
                  ((n.lastValue = n.text.value = ""), n.onCompositionEnd()),
                  n.resetSelection());
              }),
              t.on("changeSelection", this.setAriaLabel.bind(this)),
              (this.resetSelection = v
                ? this.$resetSelectionIOS
                : this.$resetSelection),
              this.$isFocused && t.onFocus(),
              (this.inputHandler = null),
              (this.afterContextMenu = !1),
              r.addCommandKeyListener(
                this.text,
                function (e, r, i) {
                  if (n.inComposition) return;
                  return t.onCommandKey(e, r, i);
                },
                t,
              ),
              r.addListener(this.text, "select", this.onSelect.bind(this), t),
              r.addListener(this.text, "input", this.onInput.bind(this), t),
              r.addListener(this.text, "cut", this.onCut.bind(this), t),
              r.addListener(this.text, "copy", this.onCopy.bind(this), t),
              r.addListener(this.text, "paste", this.onPaste.bind(this), t),
              (!("oncut" in this.text) ||
                !("oncopy" in this.text) ||
                !("onpaste" in this.text)) &&
                r.addListener(
                  e,
                  "keydown",
                  function (e) {
              ...
              (this.syncComposition = u
                .delayedCall(this.onCompositionUpdate.bind(this), 50)
              ...
              r.addListener(this.text, "keyup", this.onKeyup.bind(this), t),
              r.addListener(
                this.text,
                "keydown",
                this.syncComposition.bind(this),
                t,
              ),
              r.addListener(
                this.text,
              ...
              r.addListener(
                ...
                "mousedown",
                function (e) {
                  (e.preventDefault(), n.onContextMenuClose());
                },
                t,
              ),
              r.addListener(
              ...
              v && this.addIosSelectionHandler(e, t, this.text));
          }
          return (
            (e.prototype.addIosSelectionHandler = function (e, t, n) {
              var r = this,
                i = null,
                s = !1;
              (n.addEventListener(
              ...
              var o = function (e) {
                ...
                if (s || r.inComposition || t.$mouseHandler.isMousePressed)
                  return;
                if (r.copied) return;
                var i = n.selectionStart,
                  ...
                  a = 0;
                if (i == 0) u = p.up;
                else if (i == 1) u = p.home;
                else if (o > r.lastSelectionEnd && r.lastValue[o] == "\n")
                  u = p.end;
                else if (i < r.lastSelectionStart && r.lastValue[i - 1] == " ")
                  ((u = p.left), (a = d.option));
                else if (
                  i < r.lastSelectionStart ||
                  (i == r.lastSelectionStart &&
                    r.lastSelectionEnd != r.lastSelectionStart &&
                    i == o)
                )
                  u = p.left;
                else if (
                  o > r.lastSelectionEnd &&
                  r.lastValue.slice(0, o).split("\n").length > 2
                )
                  u = p.down;
                else if (o > r.lastSelectionEnd && r.lastValue[o - 1] == " ")
                  ((u = p.right), (a = d.option));
                else if (
                  o > r.lastSelectionEnd ||
                  (o == r.lastSelectionEnd &&
                    r.lastSelectionEnd != r.lastSelectionStart &&
                ...
                i !== o && (a |= d.shift);
                if (u) {
                  var f = t.onCommandKey({}, a, u);
                  if (!f && t.commands) {
                    u = p.keyCodeToString(u);
                    var l = t.commands.findKeyCommand(a, u);
                    l && t.execCommand(l);
                  }
                  ((r.lastSelectionStart = i),
                    (r.lastSelectionEnd = o),
                    r.resetSelection(""));
                }
              };
            ...
            (e.prototype.onContextMenuClose = function () {
              var e = this;
              (clearTimeout(this.closeTimeout),
                (this.closeTimeout = setTimeout(function () {
                  (e.tempStyle &&
                    ((e.text.style.cssText = e.tempStyle), (e.tempStyle = "")),
                    (e.host.renderer.$isMousePressed = !1),
                    e.host.renderer.$keepTextAreaAtCursor &&
            ...
            (e.prototype.onKeyup = function (e) {
              (e.keyCode == 27 &&
                this.text.value.length < this.text.selectionStart &&
                (this.inComposition || (this.lastValue = this.text.value),
                (this.lastSelectionStart = this.lastSelectionEnd = -1),
                this.resetSelection()),
                this.syncComposition());
            }),
            (e.prototype.cancelComposition = function () {
              ((this.ignoreFocusEvents = !0),
                this.text.blur(),
                this.text.focus(),
                (this.ignoreFocusEvents = !1));
            }),
            (e.prototype.onCompositionStart = function (e) {
              if (
                this.inComposition ||
                !this.host.onCompositionStart ||
                this.host.$readOnly
              )
                return;
              this.inComposition = {};
              if (this.commandMode) return;
              (e.data && (this.inComposition.useTextareaForIME = !1),
              ...
              var t = this.host.getSelectionRange();
              ((t.end.row = t.start.row),
                (t.end.column = t.start.column),
                (this.inComposition.markerRange = t),
                (this.inComposition.selectionStart = this.lastSelectionStart),
                this.host.onCompositionStart(this.inComposition),
                this.inComposition.useTextareaForIME
                  ? ((this.lastValue = this.text.value = ""),
                    (this.lastSelectionStart = 0),
                    (this.lastSelectionEnd = 0))
                  : (this.text.msGetInputContext &&
                      (this.inComposition.context =
                        this.text.msGetInputContext()),
                    this.text.getInputContext &&
                      (this.inComposition.context =
                        this.text.getInputContext())));
            }),
            (e.prototype.onCompositionUpdate = function () {
              if (
                !this.inComposition ||
                !this.host.onCompositionUpdate ||
                this.host.$readOnly
              )
                return;
              ...
              if (this.inComposition.useTextareaForIME)
                ...
                (this.sendText(e),
                  this.inComposition.markerRange &&
                    (this.inComposition.context &&
                      (this.inComposition.markerRange.start.column =
                        this.inComposition.selectionStart =
                          this.inComposition.context.compositionStartOffset),
            ...
            (e.prototype.onPaste = function (e) {
              var t = this.handleClipboardData(e);
              if (a.pasteCancelled()) return;
              typeof t == "string"
                ? (t && this.host.onPaste(t, e),
                  s.isIE && setTimeout(this.resetSelection),
                  r.preventDefault(e))
                : ((this.text.value = ""), (this.pasted = !0));
            }),
            (e.prototype.doCopy = function (e, t) {
              var n = this,
                i = this.host.getCopyText();
              if (!i) return r.preventDefault(e);
              this.handleClipboardData(e, i)
                ? (v &&
                  ...
                  t ? this.host.onCut() : this.host.onCopy(),
                  r.preventDefault(e))
                : ((this.copied = !0),
                  (this.text.value = i),
                  this.text.select(),
                  setTimeout(function () {
                    ((n.copied = !1),
                      n.resetSelection(),
                      t ? n.host.onCut() : n.host.onCopy());
                  }));
            }),
            (e.prototype.handleClipboardData = function (e, t, n) {
              ...
              try {
                ...
                if (!n) return this.handleClipboardData(e, t, !0);
              }
            }),
            ...
            (e.prototype.sendText = function (e, t) {
              this.afterContextMenu && (this.afterContextMenu = !1);
              if (this.pasted)
                return (
                  this.resetSelection(),
                  e && this.host.onPaste(e),
                  (this.pasted = !1),
                  ""
                );
              var n = this.text.selectionStart,
                r = this.text.selectionEnd,
                i = this.lastSelectionStart,
                o = this.lastValue.length - this.lastSelectionEnd,
                u = e,
                a = e.length - n,
                f = e.length - r,
                l = 0;
              while (i > 0 && this.lastValue[l] == e[l]) (l++, i--);
              ((u = u.slice(l)), (l = 1));
              while (
                o > 0 &&
                this.lastValue.length - l > this.lastSelectionStart - 1 &&
                this.lastValue[this.lastValue.length - l] == e[e.length - l]
              )
                (l++, o--);
              ((a -= l - 1), (f -= l - 1));
              var c = u.length - l + 1;
              (c < 0 && ((i = -c), (c = 0)), (u = u.slice(0, c)));
              if (!t && !u && !a && !i && !o && !f) return "";
              this.sendingText = !0;
              var h = !1;
              return (
                s.isAndroid && u == ". " && ((u = "  "), (h = !0)),
                (u && !i && !o && !a && !f) || this.commandMode
                  ? this.host.onTextInput(u)
                  : this.host.onTextInput(u, {
                      extendLeft: i,
                      extendRight: o,
                      restoreStart: a,
                ...
                (this.sendingText = !1),
                (this.lastValue = e),
                (this.lastSelectionStart = n),
                (this.lastSelectionEnd = r),
                (this.lastRestoreEnd = f),
                h ? "\n" : u
              );
            }),
            (e.prototype.onSelect = function (e) {
              ...
              var n = function (e) {
                return (
                  e.selectionStart === 0 &&
                  e.selectionEnd >= t.lastValue.length &&
                  e.value === t.lastValue &&
                  t.lastValue &&
                  e.selectionEnd !== t.lastSelectionEnd
                );
              };
              this.copied
                ? (this.copied = !1)
                : n(this.text)
                  ? (this.host.selectAll(), this.resetSelection())
                  : g &&
                    this.text.selectionStart != this.lastSelectionStart &&
                    this.resetSelection();
            }),
            (e.prototype.$resetSelectionIOS = function (e) {
              if (!this.$isFocused || (this.copied && !e) || this.sendingText)
                return;
              e || (e = "");
              var t = "\n ab" + e + "cde fg\n";
              t != this.text.value && (this.text.value = this.lastValue = t);
              var n = 4,
                r = 4 + (e.length || (this.host.selection.isEmpty() ? 0 : 1));
              ((this.lastSelectionStart != n || this.lastSelectionEnd != r) &&
                this.text.setSelectionRange(n, r),
                (this.lastSelectionStart = n),
                (this.lastSelectionEnd = r));
            }),
            (e.prototype.$resetSelection = function () {
              ...
              var t = 0,
                ...
                i = function (t, n) {
                  ...
                  for (
                    var i = 1;
                    i <= t - e.rowStart && i < 2 * e.numberOfExtraLines + 1;
                    i++
                  )
                    r += e.host.session.getLine(t - i).length + 1;
                  return r;
                };
              if (this.host.session) {
                var s = this.host.selection,
                  o = s.getRange(),
                  u = s.cursor.row;
                if (u === this.rowEnd + 1)
                  ((this.rowStart = this.rowEnd + 1),
                    (this.rowEnd =
                      this.rowStart + 2 * this.numberOfExtraLines));
                else if (u === this.rowStart - 1)
                  ((this.rowEnd = this.rowStart - 1),
                    (this.rowStart =
                      this.rowEnd - 2 * this.numberOfExtraLines));
                else if (u < this.rowStart - 1 || u > this.rowEnd + 1)
                  ((this.rowStart =
                    u > this.numberOfExtraLines
                      ? u - this.numberOfExtraLines
                      : 0),
                    (this.rowEnd =
                      u > this.numberOfExtraLines
                        ? u + this.numberOfExtraLines
                        : 2 * this.numberOfExtraLines));
                var a = [];
                for (var f = this.rowStart; f <= this.rowEnd; f++)
                  a.push(this.host.session.getLine(f));
                ((r = a.join("\n")),
                  (t = i(o.start.row, o.start.column)),
                  (n = i(o.end.row, o.end.column)));
                if (o.start.row < this.rowStart) {
                  var l = this.host.session.getLine(this.rowStart - 1);
                  ((t = o.start.row < this.rowStart - 1 ? 0 : t),
                    (n += l.length + 1),
                    (r = l + "\n" + r));
                } else if (o.end.row > this.rowEnd) {
                  var c = this.host.session.getLine(this.rowEnd + 1);
                  ((n = o.end.row > this.rowEnd + 1 ? c.length : o.end.column),
                    (n += r.length + 1),
                    (r = r + "\n" + c));
                } else g && u > 0 && ((r = "\n" + r), (n += 1), (t += 1));
                r.length > h &&
                ...
                var p = r + "\n\n";
                p != this.lastValue &&
                  ((this.text.value = this.lastValue = p),
                  (this.lastSelectionStart = this.lastSelectionEnd = p.length));
              }
              this.afterContextMenu &&
                ((this.lastSelectionStart = this.text.selectionStart),
                (this.lastSelectionEnd = this.text.selectionEnd));
              if (
                this.lastSelectionEnd != n ||
                this.lastSelectionStart != t ||
                this.text.selectionEnd != this.lastSelectionEnd
              )
                try {
                  (this.text.setSelectionRange(t, n),
                    (this.lastSelectionStart = t),
                    (this.lastSelectionEnd = n));
                } catch (d) {}
              this.inComposition = !1;
            ...
            (e.prototype.setNumberOfExtraLines = function (e) {
              ((this.rowStart = Number.MAX_SAFE_INTEGER),
                (this.rowEnd = Number.MIN_SAFE_INTEGER));
              if (e < 0) {
                this.numberOfExtraLines = 0;
              ...
              this.numberOfExtraLines = e;
            }),
            (e.prototype.setAriaLabel = function () {
              var e = "";
              this.host.$textInputAriaLabel &&
                (e += "".concat(this.host.$textInputAriaLabel, ", "));
              if (this.host.session) {
                var t = this.host.session.selection.cursor.row;
                e += i("text-input.aria-label", "Cursor at row $0", [t + 1]);
              }
              this.text.setAttribute("aria-label", e);
            }),
            (e.prototype.setAriaOptions = function (e) {
              (e.activeDescendant
                ...
                e.role && this.text.setAttribute("role", e.role),
                e.setLabel &&
                  (this.text.setAttribute(
            ...
            (e.prototype.focus = function () {
              ...
              if (this.tempStyle || c || this.$focusScroll == "browser")
                return this.text.focus({ preventScroll: !0 });
              var t = this.text.style.top;
              ((this.text.style.position = "fixed"),
                (this.text.style.top = "0px"));
              try {
                var n = this.text.getBoundingClientRect().top != 0;
              } catch (r) {
                return;
              }
              var i = [];
              if (n) {
                var s = this.text.parentElement;
              ...
              (this.text.focus({ preventScroll: !0 }),
                n &&
                  i.forEach(function (e) {
                    e.removeAttribute("ace_nocontext");
                  }),
                setTimeout(function () {
                  ((e.text.style.position = ""),
                    e.text.style.top == "0px" && (e.text.style.top = t));
                }, 0));
            }),
            ...
            (e.prototype.setInputHandler = function (e) {
              this.inputHandler = e;
            }),
            ...
            (e.prototype.moveToMouse = function (e, t) {
              var n = this;
              (this.tempStyle || (this.tempStyle = this.text.style.cssText),
                (this.text.style.cssText =
                  (t ? "z-index:100000;" : "") +
                  (s.isIE ? "opacity:0.1;" : "") +
                  "text-indent: -" +
                  (this.lastSelectionStart + this.lastSelectionEnd) *
                    this.host.renderer.characterWidth *
                    0.5 +
                  "px;"));
              var i = this.host.container.getBoundingClientRect(),
                u = o.computedStyle(this.host.container),
                a = i.top + (parseInt(u.borderTopWidth) || 0),
                f = i.left + (parseInt(u.borderLeftWidth) || 0),
                l = i.bottom - a - this.text.clientHeight - 2,
                c = function (e) {
                  o.translate(
                    n.text,
                    e.clientX - f - 2,
              ...
              ((this.host.renderer.$isMousePressed = !0),
                clearTimeout(this.closeTimeout),
                s.isWin &&
                  r.capture(
                    this.host.container,
                    c,
                    this.onContextMenuClose.bind(this),
                  ));
            }),
            (e.prototype.destroy = function () {
              this.text.parentElement &&
    ...
    function (e, t, n) {
      ...
      function a(e, t, n) {
        if (e.start.row == e.end.row)
          var r = 2 * t.column - e.start.column - e.end.column;
        else if (
          e.start.row == e.end.row - 1 &&
          !e.start.column &&
          !e.end.column
        )
          var r = 3 * t.column - 2 * n.getLine(e.start.row).length;
        else var r = 2 * t.row - e.start.row - e.end.row;
        return r < 0
            ...
            (e.prototype.select = function () {
              ...
              if (this.$clickSelection) {
                ...
                if (r == -1) e = this.$clickSelection.end;
                  ...
                  var i = a(this.$clickSelection, n, t.session);
            ...
            (e.prototype.extendSelectionBy = function (e) {
              ...
              if (this.$clickSelection) {
                ...
                if (s == -1 && o <= 0) {
                  ...
                  var u = a(this.$clickSelection, r, n.session);
        ...
        l = (function () {
          ...
          return (
            ...
            (e.prototype.setTheme = function (e) {
              (this.theme &&
                (this.theme.isDark &&
                  s.removeCssClass(this.getElement(), "ace_dark"),
                this.theme.cssClass &&
                  s.removeCssClass(this.getElement(), this.theme.cssClass)),
                e.isDark && s.addCssClass(this.getElement(), "ace_dark"),
                e.cssClass && s.addCssClass(this.getElement(), e.cssClass),
                (this.theme = { isDark: e.isDark, cssClass: e.cssClass }));
            }),
      ...
      var p = (function (e) {
        ...
        return (
          ...
          (t.prototype.addToEditor = function (e) {
            (e.on("mousemove", this.onMouseMove), e.on("mousedown", this.hide));
          ...
          (t.prototype.removeFromEditor = function (e) {
            ...
            (t &&
              typeof t.removeEventListener == "function" &&
              t.removeEventListener("mouseout", this.onMouseOut, !0),
              this.timeout &&
          ...
          (t.prototype.showForRange = function (e, t, n, r) {
            ...
            var o = i.textToScreenCoordinates(t.start.row, t.start.column),
              a = i.scroller.getBoundingClientRect();
            ...
            ((f.innerHTML = ""),
              ...
              this.$setPosition(e, o, !0, t),
              s.$fixPositionBug(f));
          }),
          (t.prototype.$setPosition = function (e, t, n, r) {
            var i = 10;
            n && this.addMarker(r, e.session);
            var s = e.renderer,
              o = this.getElement(),
              u = o.offsetHeight,
              a = o.offsetWidth,
              f = t.pageY,
              l = t.pageX,
              c = window.innerHeight - f - s.lineHeight,
              h = this.$shouldPlaceAbove(u, f, c - i);
            ((o.style.maxHeight = (h ? f : c) - i + "px"),
              (o.style.top = h ? "" : f + s.lineHeight + "px"),
              (o.style.bottom = h ? window.innerHeight - f + "px" : ""),
              (o.style.left = Math.min(l, window.innerWidth - a - i) + "px"));
          }),
          (t.prototype.$shouldPlaceAbove = function (e, t, n) {
            return !(t - e < 0 && t < n);
          }),
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      function l(e) {
        ...
        ((e.$tooltip = new c(t)),
          e.$tooltip.addToEditor(t),
          e.$tooltip.setDataProvider(function (t, n) {
            var r = t.getDocumentPosition().row;
            e.$tooltip.showTooltip(r);
          }),
      ...
      var r =
        ...
        s = e("../lib/dom"),
        o = e("./mouse_event").MouseEvent,
        u = e("../tooltip").HoverTooltip,
        a = e("../config").nls,
        f = e("../range").Range;
      t.GutterHandler = l;
      var c = (function (e) {
        function t(n) {
          var r = e.call(this, n.container) || this;
          ((r.id = "gt" + ++t.$uid), (r.editor = n), r.visibleTooltipRow);
          var i = r.getElement();
          return (
            i.setAttribute("role", "tooltip"),
            i.setAttribute("id", r.id),
            (i.style.pointerEvents = "auto"),
            (r.idleTime = 50),
            (r.onDomMouseMove = r.onDomMouseMove.bind(r)),
            (r.onDomMouseOut = r.onDomMouseOut.bind(r)),
            r.setClassName("ace_gutter-tooltip"),
            r
          );
        }
        return (
          r(t, e),
          (t.prototype.onDomMouseMove = function (e) {
            var t = new o(e, this.editor);
            this.onMouseMove(t, this.editor);
          }),
          (t.prototype.onDomMouseOut = function (e) {
            var t = new o(e, this.editor);
            this.onMouseOut(t);
          }),
          (t.prototype.addToEditor = function (t) {
            var n = t.renderer.$gutter;
            (n.addEventListener("mousemove", this.onDomMouseMove),
              n.addEventListener("mouseout", this.onDomMouseOut),
              e.prototype.addToEditor.call(this, t));
          }),
          (t.prototype.removeFromEditor = function (t) {
            var n = t.renderer.$gutter;
            (n.removeEventListener("mousemove", this.onDomMouseMove),
              n.removeEventListener("mouseout", this.onDomMouseOut),
              e.prototype.removeFromEditor.call(this, t));
          }),
          (t.prototype.destroy = function () {
            (this.editor && this.removeFromEditor(this.editor),
          ...
          (t.prototype.showTooltip = function (e) {
            var n,
              r = this.editor.renderer.$gutterLayer,
              i = r.$annotations[e],
              o;
            i
              ? (o = {
            ...
            if (u && r.$showFoldedAnnotations) {
              var a = {
                ...
                l = { error: 1, security: 2, warning: 3, info: 4, hint: 5 },
                c;
              for (var h = e + 1; h <= u.end.row; h++) {
                if (!r.$annotations[h]) continue;
                for (var p = 0; p < r.$annotations[h].text.length; p++) {
                  var d = r.$annotations[h].type[p];
                  a[d].push(r.$annotations[h].text[p]);
                  if (!c || l[d] < l[c]) c = d;
                }
              }
              if (["error", "security", "warning"].includes(c)) {
                var v = "".concat(
                  t.annotationsToSummaryString(a),
                  " in folded code.",
                );
                (o.displayText.push(v), o.type.push(c + "_fold"));
              }
            }
            if (o.displayText.length === 0) return this.hide();
            var m = {
                error: [],
                security: [],
                warning: [],
              ...
              g = r.$useSvgGutterIcons ? "ace_icon_svg" : "ace_icon";
            for (var h = 0; h < o.displayText.length; h++) {
              var y = s.createElement("span"),
                b = s.createElement("span");
              ((n = b.classList).add.apply(n, ["ace_".concat(o.type[h]), g]),
                b.setAttribute(
                  "aria-label",
                  "".concat(
                    t.annotationLabels[o.type[h].replace("_fold", "")].singular,
                  ),
                ),
                b.setAttribute("role", "img"),
                b.appendChild(s.createTextNode(" ")),
                y.appendChild(b),
                y.appendChild(s.createTextNode(o.displayText[h])),
                y.appendChild(s.createElement("br")),
                m[o.type[h].replace("_fold", "")].push(y));
            }
            var w = s.createElement("span");
            (m.error.forEach(function (e) {
              return w.appendChild(e);
            }),
              m.security.forEach(function (e) {
                return w.appendChild(e);
              }),
              m.warning.forEach(function (e) {
                return w.appendChild(e);
              }),
              m.info.forEach(function (e) {
                return w.appendChild(e);
              }),
              m.hint.forEach(function (e) {
                return w.appendChild(e);
              }),
              w.setAttribute("aria-live", "polite"));
            var E = this.$findLinkedAnnotationNode(e);
            E && E.setAttribute("aria-describedby", this.id);
            var S = f.fromPoints({ row: e, column: 0 }, { row: e, column: 0 });
            (this.showForRange(this.editor, S, w),
              (this.visibleTooltipRow = e),
              this.editor._signal("showGutterTooltip", this));
          }),
          (t.prototype.$setPosition = function (t, n, r, i) {
            var s = this.$findCellByRow(i.start.row);
            if (!s) return;
            var o = s && s.element,
              u = o && o.querySelector(".ace_gutter_annotation");
            if (!u) return;
            var a = u.getBoundingClientRect();
            if (!a) return;
            var f = { pageX: a.right, pageY: a.top };
            return e.prototype.$setPosition.call(this, t, f, !1, i);
          }),
          (t.prototype.$shouldPlaceAbove = function (e, t, n) {
            return n < e;
          }),
          (t.prototype.$findLinkedAnnotationNode = function (e) {
            var t = this.$findCellByRow(e);
            if (t) {
              var n = t.element;
              if (n.childNodes.length > 2) return n.childNodes[2];
            }
          }),
          (t.prototype.$findCellByRow = function (e) {
            return this.editor.renderer.$gutterLayer.$lines.cells.find(
              function (t) {
                return t.row === e;
              },
            );
          ...
          (t.prototype.hide = function (t) {
            ...
            if (this.visibleTooltipRow != undefined) {
              var n = this.$findLinkedAnnotationNode(this.visibleTooltipRow);
              n && n.removeAttribute("aria-describedby");
            }
          ...
          (t.annotationsToSummaryString = function (e) {
            var n,
              r,
              s = [],
              o = ["error", "security", "warning", "info", "hint"];
            try {
          ...
          (t.prototype.isOutsideOfText = function (e) {
            var t = e.editor,
              n = t.renderer.$gutter.getBoundingClientRect();
            return !(
              e.clientX >= n.left &&
              e.clientX <= n.right &&
              e.clientY >= n.top &&
      ...
      t.addTouchListeners = function (e, t) {
        function b() {
          ...
          ((y = s.buildDom(
            [
              "div",
              { class: "ace_mobile-menu", onclick: u },
              ["span"],
        ...
        c = (function () {
          ...
          return (
            ...
            (e.prototype.captureMouse = function (e, t) {
              ...
              (n.on("beforeEndOperation", p),
                n.startOperation({ command: { name: "mouse" } }),
                (o.$onCaptureMouseMove = f),
                (o.releaseMouse = r.capture(this.editor.container, f, l)),
                h());
            }),
              ...
              if (
                ...
                for (var l = 0; l < a.length; l++) {
                  ...
                  if (f >= s.column) {
                    ...
                    var p = s.column - (f - c.value.length),
                      d = c.value.indexOf("*/"),
                      v = c.value.indexOf("/**", d > -1 ? d + 2 : 0);
                ...
                if (/\s*\*/.test(u))
                  return /^\s*\*/.test(o)
                    ? {
                        text: i + m + "* ",
                        selection: [1, 2 + m.length, 1, 2 + m.length],
                      }
                    : {
                        text: i + m + " * ",
          ...
          return (
            ...
            (e.prototype.update = function (e, t, n, s) {
              ...
              var o = s.firstRow,
                u = s.lastRow,
                a = {},
                f = n.$editor && n.$editor.$search,
                l = f && f.$isMultilineSearch(n.$editor.getLastSearchOptions());
              for (var c = o; c <= u; c++) {
                var h = this.cache[c];
                if (h == null || n.getValue().length != this.docLen) {
                  if (l) {
                    ...
                    if (p) {
                      ...
                      (d > c && (c = d),
                        h.push(
                          new i(p.startRow, p.startCol, p.endRow, p.endCol),
                        ));
                    }
                    h.length > this.MAX_RANGES &&
                      (h = h.slice(0, this.MAX_RANGES));
                  } else
                    ((h = r.getMatchOffsets(n.getLine(c), this.regExp)),
                      h.length > this.MAX_RANGES &&
                        (h = h.slice(0, this.MAX_RANGES)),
                      (h = h.map(function (e) {
          ...
          (this.getCommentFoldRange = function (e, t, n) {
            ...
            if (s && /^comment|string/.test(u)) {
              ...
              ((f.start.row = i.getCurrentTokenRow()),
                (f.start.column = i.getCurrentTokenColumn() + s.value.length),
                (i = new o(this, e, t)));
              ...
              if (f.start.row == f.end.row && f.start.column > f.end.column)
                return;
              return f;
            }
          }),
  ...
  ace.define(
    ...
    function (e, t, n) {
        ...
        m = (function () {
          function e(t, n) {
            (this.doc,
              ...
              (this.bgTokenizer = new p(new f().getTokenizer(), this)));
            var r = this;
          ...
          return (
              ...
              ((this.curOp = null),
                this.on(
                  ...
                  function () {
                    (e.curOp ||
                      (e.startOperation(),
                      (e.curOp.selectionBefore = e.$lastSel)),
                      (e.curOp.docChanged = !0));
                  },
                  !0,
                ),
                this.on(
                ...
                (this.$operationResetTimer = i.delayedCall(
            ...
            (e.prototype.endOperation = function (e) {
              if (this.curOp) {
                ...
                ((this.curOp.selectionAfter = t),
                  (this.$lastSel = this.selection.toJSON()),
                  this.getUndoManager().addSelection(t),
            ...
            Object.defineProperty(e.prototype, "widgetManager", {
              get: function () {
                ...
                return (
                  ...
                  this.$editor && e.attach(this.$editor),
                  e
                );
              },
              set: function (e) {
            ...
            (e.fromJSON = function (t) {
              ...
              var n = new v();
              ((n.$undoStack = t.history.$undoStack),
                (n.$redoStack = t.history.$redoStack),
            ...
            (e.prototype.removeGutterCustomWidget = function (e) {
              this.$editor &&
                this.$editor.renderer.$gutterLayer.$removeCustomWidget(e);
            }),
            (e.prototype.addGutterCustomWidget = function (e, t) {
              this.$editor &&
                this.$editor.renderer.$gutterLayer.$addCustomWidget(e, t);
            }),
      ...
      ((m.$uid = 0),
        ...
        (m.prototype.isFullWidth = N),
        r.implement(m.prototype, u));
      var g = 1,
        y = 2,
        b = 3,
        w = 4,
      ...
      (e("./edit_session/folding").Folding.call(m.prototype),
        ...
        o.defineOptions(m.prototype, "session", {
          wrap: {
            set: function (e) {
              !e || e == "off"
                ? (e = !1)
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      function f(e, t) {
        var n = 5e3,
          r = { row: t, column: 0 },
          i = e.doc.positionToIndex(r),
          s = i + n,
          o = e.doc.indexToPosition(s),
          u = o.row;
        return u + 1;
      }
      var r = e("./lib/lang"),
        ...
        o = (function () {
          ...
          return (
            ...
            (e.prototype.findAll = function (e) {
                ...
                for (var g, y = 0; y < i.length; y++)
                  if (this.$isMultilineSearch(t)) {
                    ...
                    if (g) {
                      ...
                      (w > y && (y = w),
                        o.push(
                          new s(g.startRow, g.startCol, g.endRow, g.endCol),
                        ));
                    }
                  } else {
              ...
              if (n) {
                var S = n.start.column,
                  x = n.end.column,
                  y = 0,
                  h = o.length - 1;
                while (y < h && o[y].start.column < S && o[y].start.row == 0)
                  y++;
                var T = n.end.row - n.start.row;
                while (y < h && o[h].end.column > x && o[h].end.row == T) h--;
                o = o.slice(y, h + 1);
                for (y = 0, h = o.length; y < h; y++)
                  ((o[y].start.row += n.start.row),
                    (o[y].end.row += n.start.row));
              }
              return o;
            }),
              ...
              for (var o = n; o <= r; ) {
                ...
                if (l) {
                  var c = i.slice(0, l.index).split("\n"),
                    ...
                    v = p + h.length - 1,
                    m =
                      h.length == 1 ? d + h[0].length : h[h.length - 1].length;
                  return { startRow: p, startCol: d, endRow: v, endCol: m };
                }
              }
              return null;
            }),
              ...
              for (var l = r; l >= i; ) {
                ...
                if (p) {
                  var d = s.slice(0, p.index).split("\n"),
                    ...
                    y = m + v.length - 1,
                    b =
                      v.length == 1 ? g + v[0].length : v[v.length - 1].length;
                  return { startRow: m, startCol: g, endRow: y, endCol: b };
                }
              }
              return null;
            }),
            (e.prototype.$matchIterator = function (e, t) {
              ...
              if (!n) return !1;
              var i = this.$isMultilineSearch(t),
                s = this.$multiLineForward,
                o = this.$multiLineBackward,
                u = t.backwards == 1,
                a = t.skipCurrent != 0,
                f = n.unicode,
                l = t.range,
                c = t.start;
              (c || (c = l ? l[u ? "end" : "start"] : e.selection.getRange()),
                c.start && (c = c[a != u ? "end" : "start"]));
              var h = l ? l.start.row : 0,
                p = l ? l.end.row : e.getLength() - 1;
              if (u)
                var d = function (e) {
                  var n = c.row;
                  ...
                  if (t.wrap == 0) return;
                  for (n = p, h = c.row; n >= h; n--)
                    if (m(n, Number.MAX_VALUE, e)) return;
                };
              else
                var d = function (e) {
                  var n = c.row;
              ...
              if (t.$isMultiLine)
                ...
                var m = function (t, s, u) {
                  if (i) {
                    var a = o(e, n, s, t, h);
                    if (!a) return !1;
                    if (u(a.startRow, a.startCol, a.endRow, a.endCol))
                      return !0;
                  } else {
                    var l = e.getLine(t),
                      c = [],
          ...
          return (
            ...
            (e.prototype.$onGutterKeyDown = function (e) {
              if (this.annotationTooltip.isOpen) {
                (e.preventDefault(),
                  e.keyCode === r.escape && this.annotationTooltip.hide());
                return;
              }
                  ...
                  setTimeout(
                    function () {
                      var e = this.$rowToRowIndex(
                        ...
                        t = this.$findNearestFoldLaneWidget(e),
                ...
                switch (this.activeLane) {
                  case "fold":
                    var t = this.$rowIndexToRow(this.activeRowIndex),
                      n = this.editor.session.$gutterCustomWidgets[t];
                    if (n)
                      n.callbacks &&
                        n.callbacks.onClick &&
                        n.callbacks.onClick(e, t);
                    else {
                  ...
                  case "annotation":
                    (this.annotationTooltip.showTooltip(
                      ...
                      (this.annotationTooltip.$fromKeyboard = !0));
                }
                return;
              }
            }),
            ...
            (e.prototype.$findNearestFoldLaneWidget = function (e) {
              ...
              while (e - t > 0 || e + t < this.lines.getLength() - 1) {
                ...
                if (
                  ...
                  this.$isCustomWidgetVisible(e + t)
                )
                  return e + t;
            ...
            (e.prototype.$moveFoldWidgetUp = function () {
              ...
              while (e > 0) {
                e--;
                if (
                  this.$isFoldWidgetVisible(e) ||
                  this.$isCustomWidgetVisible(e)
                ) {
                  (this.$blurFoldWidget(this.activeRowIndex),
                    this.$blurCustomWidget(this.activeRowIndex),
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r =
        ...
        w = e("./keyboard/gutter_handler").GutterKeyboardHandler,
        E = e("./config").nls,
        S = e("./clipboard"),
        x = e("./lib/keys"),
        T = e("./lib/event"),
        N = e("./tooltip").HoverTooltip,
        C = (function () {
          function e(t, n, r) {
          ...
          return (
            ...
            Object.defineProperty(e.prototype, "hoverTooltip", {
              get: function () {
                return (
                  this.$hoverTooltip ||
                  (this.$hoverTooltip = new N(this.container))
                );
              },
              set: function (e) {
                (this.$hoverTooltip && this.$hoverTooltip.destroy(),
                  (this.$hoverTooltip = e));
              },
              enumerable: !1,
              configurable: !0,
      ...
      ((C.$uid = 0),
        (C.prototype.curOp = null),
        (C.prototype.prevOp = {}),
        (C.prototype.$mergeableCommands = ["backspace", "del", "insertstring"]),
        ...
        i.implement(C.prototype, v),
        y.defineOptions(C.prototype, "editor", {
          selectionStyle: {
            set: function (e) {
              (this.onSelectionChange(),
          ...
          readOnly: {
            set: function (e) {
                ...
                this.$readOnlyCallback ||
                  (this.$readOnlyCallback = function (e) {
                    ...
                    if (n) {
                      ...
                      ((r.textContent = E(
                        "editor.tooltip.disable-editing",
                        "Editing is disabled",
                      )),
                        t.hoverTooltip.isOpen ||
                          t.hoverTooltip.showForRange(
                            t,
                            t.getSelectionRange(),
                            r,
                          ));
              ...
              e
                ? (T.addListener(n, "keydown", this.$readOnlyCallback, this),
                  this.commands.on("exec", this.$readOnlyCallback),
                  this.commands.on(
                    "commandUnavailable",
                    this.$readOnlyCallback,
                  ))
                : (T.removeListener(n, "keydown", this.$readOnlyCallback),
              ...
              e
                ? ((this.renderer.enableKeyboardAccessibility = !0),
                  ...
                  this.renderer.scroller.setAttribute(
                    "aria-roledescription",
                    E("editor.scroller.aria-roledescription", "editor"),
                  ),
                  ...
                  this.renderer.$gutter.setAttribute(
                    "aria-roledescription",
                    E("editor.gutter.aria-roledescription", "editor gutter"),
                  ),
                  this.renderer.$gutter.setAttribute(
                    "aria-label",
                    E(
                  ...
                  r || (r = new w(this)),
                  r.addListener(),
                  this.textInput.setAriaOptions({ setLabel: !0 }))
  ...
  ace.define(
    ...
    function (e, t, n) {
        ...
        f = (function () {
          ...
          return (
            ...
            (e.prototype.setAnnotations = function (e) {
              ...
              for (var t = 0; t < e.length; t++) {
                ...
                ((o = o ? s.escapeHTML(o) : n.html || ""),
                  (u = u ? u : n.html || ""),
                  i.text.indexOf(o) === -1 &&
                    (i.text.push(o), i.type.push(a), i.displayText.push(u)));
                var f = n.className;
                f
                  ? (i.className = f)
                  : a === "error"
                    ? (i.className = " ace_error")
                    : a === "security" && !/\bace_error\b/.test(i.className)
                      ? (i.className = " ace_security")
                      : a === "warning" &&
                          !/\bace_(error|security)\b/.test(i.className)
                        ? (i.className = " ace_warning")
                        : a === "info" && !i.className
                          ? (i.className = " ace_info")
                          : a === "hint" &&
                            !i.className &&
                            (i.className = " ace_hint");
              }
            }),
            ...
            (e.prototype.updateLineHighlight = function () {
              this.$showCursorMarker && this.$updateCursorMarker();
              if (!this.$highlightGutterLine) return;
            ...
            (e.prototype.$updateCursorMarker = function () {
              if (!this.session) return;
              var e = this.session;
              this.$highlightElement ||
                ((this.$highlightElement = r.createElement("div")),
              ...
              var t = e.selection.cursor,
                n = this.config,
                i = this.$lines,
                s = n.firstRowScreen * n.lineHeight,
                o = Math.floor(s / i.canvasHeight),
                u = e.documentToScreenRow(t) * n.lineHeight,
                a = u - o * i.canvasHeight;
              (r.setStyle(
                this.$highlightElement.style,
                "height",
                n.lineHeight + "px",
              ),
                r.setStyle(this.$highlightElement.style, "top", a + "px"));
            }),
            ...
            (e.prototype.$renderCell = function (e, t, n, i) {
              var s = e.element,
                ...
                d = o.$breakpoints,
                v = o.$decorations,
                m = o.gutterRenderer || this.$renderer,
                g = this.$showFoldWidgets && o.foldWidgets,
                y = n ? n.start.row : Number.MAX_VALUE,
                b = t.lineHeight + "px",
                w = this.$useSvgGutterIcons
                  ? "ace_gutter-cell_svg-icons "
                  : "ace_gutter-cell ",
                E = this.$useSvgGutterIcons ? "ace_icon_svg" : "ace_icon",
                S = (m ? m.getText(o, i) : i + p).toString();
              (this.$highlightGutterLine &&
                (i == this.$cursorRow ||
                  (n &&
                    i < this.$cursorRow &&
                ...
                this.$annotations[i] &&
                  i !== y &&
                  (w += this.$annotations[i].className));
              if (g) {
                var x = g[i];
                x == null && (x = g[i] = o.getFoldWidget(i));
              }
              if (x) {
                var T = "ace_fold-widget ace_" + x,
                  N = x == "start" && i == y && i < n.end.row;
                if (N) {
                  T += " ace_closed";
                  var C = "",
                    k = !1;
                  for (var L = i + 1; L <= n.end.row; L++) {
                    ...
                    this.$annotations[L].className === " ace_security"
                      ? ((k = !0), (C = " ace_security_fold"))
                      : this.$annotations[L].className === " ace_warning" &&
                        C !== " ace_security_fold" &&
                        ((k = !0), (C = " ace_warning_fold"));
                  }
                  w += C;
                } else T += " ace_open";
                (f.className != T && (f.className = T),
                  r.setStyle(f.style, "height", b),
              ...
              O
                ? this.$addCustomWidget(i, O, e)
                : c && this.$removeCustomWidget(i, e);
              if (k && this.$showFoldedAnnotations) {
                ((l.className = "ace_gutter_annotation"),
                  (h.className = E),
                  (h.className += C),
                  r.setStyle(h.style, "height", b),
                  r.setStyle(l.style, "display", "block"),
                  r.setStyle(l.style, "height", b));
                var M;
                switch (C) {
                  case " ace_error_fold":
                    M = a(
                      "gutter.annotation.aria-label.error",
                      "Error, read annotations row $0",
                      [S],
                    );
                    break;
              ...
              return (
                ...
                (e.text = S),
                l.style.display === "none" && f.style.display === "none" && !O
            ...
            (e.prototype.$showFoldWidget = function (e, t) {
              ...
              if (n && n.element) {
                var i = n.element.childNodes[1];
                i &&
                  this.session.foldWidgets &&
                  this.session.foldWidgets[n.row] &&
                  r.setStyle(i.style, "display", "inline-block");
              }
            }),
            ...
            (e.prototype.$addCustomWidget = function (e, t, n) {
              ...
              if (a && a.element) {
                ...
                (f && f.remove(),
                  ...
                  (f.className = "ace_custom-widget ".concat(i)),
                  f.setAttribute("tabindex", "-1"),
                  f.setAttribute("role", "button"),
                  f.setAttribute("aria-label", s),
                  f.setAttribute("title", o),
                  r.setStyle(f.style, "display", "inline-block"),
                  r.setStyle(f.style, "height", "inherit"),
                  u &&
                    u.onClick &&
            ...
            (e.prototype.$removeCustomWidget = function (e, t) {
              (delete this.session.$gutterCustomWidgets[e],
                this.$showFoldWidget(e, t));
              var n = t || this.$getGutterCell(e);
              if (n && n.element) {
      ...
      ((f.prototype.$fixedWidth = !1),
        ...
        (f.prototype.$renderer = undefined),
        ...
        l = (function () {
          ...
          return (
            ...
            (e.prototype.$renderToken = function (e, t, n, r) {
              ...
              while ((l = o.exec(r))) {
                ...
                if (h) {
                  var y = i.session.getScreenTabSize(t + l.index),
                    b = i.$tabStrings[y].cloneNode(!0);
                  ((b.charCount = 1), u.appendChild(b), (t += y - 1));
                } else if (p)
                  if (i.showSpaces) {
                    var w = this.dom.createElement("span");
                    ((w.className = "ace_invisible ace_invisible_space"),
                      (w.textContent = s.stringRepeat(i.SPACE_CHAR, p.length)),
                      u.appendChild(w));
                  } else
                  ...
                  ((w.className =
                    ...
                    (w.textContent = s.stringRepeat(i.SPACE_CHAR, d.length)),
                    u.appendChild(w));
                } else if (v) {
                  t += 1;
                  var w = this.dom.createElement("span");
                  ((w.style.width = i.config.characterWidth * 2 + "px"),
                    (w.className = i.showSpaces
                      ? "ace_cjk ace_invisible ace_invisible_space"
                      : "ace_cjk"),
                    (w.textContent = i.showSpaces ? i.SPACE_CHAR : v),
                    u.appendChild(w));
                } else if (m) {
                  t += 1;
                  var w = this.dom.createElement("span");
              ...
              if (!f(n.type)) {
                var E = "ace_" + n.type.replace(/\./g, " ace_"),
            ...
            (e.prototype.renderIndentGuide = function (e, t, n) {
              ...
              if (t[0] == "	") {
                for (var s = 0; s < r; s++) {
                  var o = this.$tabStrings["	"].cloneNode(!0);
                  ((o.charCount = 1), e.appendChild(o));
                }
                return (this.$highlightIndentGuide(), t.substr(r));
              }
            ...
            (e.prototype.$setIndentGuideActive = function (e, t) {
              ...
              if (n !== "") {
                ...
                if (
                  e.element.classList &&
                  e.element.classList.contains("ace_line_group")
                ) {
                ...
                if (i) {
                  ...
                  s &&
                    s.classList &&
                    s.classList.contains("ace_indent-guide") &&
                    s.classList.add("ace_indent-guide-active");
                }
              }
            }),
          ...
          return (
            ...
            (e.prototype.$getZoom = function (e) {
              return !e || !e.parentElement
                ? 1
                : (Number(window.getComputedStyle(e).zoom) || 1) *
      ...
      var r = e("../lib/dom"),
        ...
        o = (function () {
          ...
          return (
            ...
            (e.prototype.setScrollBarV = function (e) {
              (this.$createCanvas(),
                (this.scrollbarV = e),
            ...
            (e.prototype.$updateDecorators = function (e) {
              ...
              if (i) {
                ...
                for (var o = 0; o < i.length; o++) {
                  var u = i[o].row,
                    a = this.getVerticalOffsetForRow(u),
                    f = a + this.lineHeight,
                    l = Math.round(this.heightRatio * a),
                    c = Math.round(this.heightRatio * f),
                    h = Math.round((l + c) / 2),
                    p = c - h;
                  (p < this.halfMinDecorationHeight &&
                    (p = this.halfMinDecorationHeight),
                    h - p < 0 && (h = p),
                    h + p > this.canvasHeight && (h = this.canvasHeight - p));
                  var d = h - p,
                    v = h + p,
                    m = v - d;
                  ((n.fillStyle = t[i[o].type] || null),
                    n.fillRect(0, d, Math.round(this.oneZoneWidth - 1), m));
                }
              }
              var g = this.renderer.session.selection.getCursor();
              if (g) {
                var y = Math.round(
                  this.getVerticalOffsetForRow(g.row) * this.heightRatio,
                );
                ((n.fillStyle = "rgba(0, 0, 0, 0.5)"),
                  n.fillRect(0, y, this.canvasWidth, 2));
              }
            }),
            (e.prototype.getVerticalOffsetForRow = function (e) {
              e |= 0;
              var t =
                this.renderer.session.documentToScreenRow(e, 0) *
                this.lineHeight;
              return t;
            }),
            (e.prototype.setDimensions = function (e) {
              ((e = e || this.renderer.layerConfig),
            ...
            (e.prototype.setZoneWidth = function () {
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("./lib/oop"),
        ...
        w = e("./lib/useragent"),
        E = e("./layer/text_util").isTextToken;
      ...
      var S = (function () {
        ...
        return (
          ...
          (e.prototype.onResize = function (e, t, n, r) {
            ...
            (r || (r = i.clientHeight || i.scrollHeight),
              !r &&
                this.$maxLines &&
                this.lineHeight > 1 &&
                (!i.style.height || i.style.height == "0px") &&
                ((i.style.height = "1px"),
          ...
          (e.prototype.$computeLayerConfig = function () {
            ...
            this.$maxLines &&
              this.lineHeight > 1 &&
              (this.$autosize(), (n = t.height <= 2 * this.lineHeight));
          ...
          (e.prototype.setGhostText = function (e, t) {
            ...
            (this.addToken(s[0].text, "ghost_text", r.row, r.column),
              (this.$ghostText = {
                text: e,
            ...
            if (s.length > 1) {
              var u = this.hideTokensAfterPosition(r.row, r.column),
                a;
              (s.slice(1).forEach(function (e) {
                var t = i.createElement("div"),
                  n = i.createElement("span");
                ((n.className = "ace_ghost_text"),
                  e.wrapped && (t.className = "ghost_text_line_wrapped"),
                  e.text.length === 0 && (e.text = " "),
                  n.appendChild(i.createTextNode(e.text)),
                  t.appendChild(n),
                  o.appendChild(t),
                  (a = t));
              }),
                u.forEach(function (e) {
                  ...
                  (E(e.type) ||
                    (t.className = "ace_" + e.type.replace(/\./g, " ace_")),
                    t.appendChild(i.createTextNode(e.value)),
                    a.appendChild(t));
                }),
              ...
              var f = this.$cursorLayer.getPixelPosition(r, !0),
                l = this.container,
                c = l.getBoundingClientRect().height,
                h = s.length * this.lineHeight,
                p = h < c - f.top;
              if (p) return;
              h < c
                ? this.scrollBy(0, (s.length - 1) * this.lineHeight)
                : this.scrollToRow(r.row);
            }
          }),
          (e.prototype.$calculateWrappedTextChunks = function (e, t) {
            var n = this.$size.scrollerWidth - this.$padding * 2,
              r = Math.floor(n / this.characterWidth) - 2;
            r = r <= 0 ? 60 : r;
            var i = e.split(/\r?\n/),
              s = [];
            for (var o = 0; o < i.length; o++) {
              var u = this.session.$getDisplayTokens(i[o], t.column),
                a = this.session.$computeWrapSplits(
                  u,
                  r,
              ...
              if (a.length > 0) {
                ...
                for (var l = 0; l < a.length; l++) {
                  ...
                  (s.push({ text: c, wrapped: !0 }), (f = a[l]));
                }
              } else s.push({ text: i[o], wrapped: !1 });
            }
            return s;
          }),
          (e.prototype.removeGhostText = function () {
          ...
          (e.prototype.hideTokensAfterPosition = function (e, t) {
            var n = this.session.getTokens(e),
              r = 0,
              i = !1,
              s = [];
            for (var o = 0; o < n.length; o++) {
              ...
              if (i) {
                (s.push({ type: u.type, value: u.value }),
                  (u.type = "hidden_token"));
                continue;
              }
              r === t && (i = !0);
          ...
          (e.prototype.setTheme = function (e, t) {
            function s(r) {
              ...
              if (n.$gutterLayer) {
                var o = r.$showGutterCursorMarker;
                o && !n.$gutterLayer.$showCursorMarker
                  ? (n.$gutterLayer.$showCursorMarker = "theme")
                  : !o &&
                    n.$gutterLayer.$showCursorMarker == "theme" &&
                    (n.$gutterLayer.$showCursorMarker = null);
              }
              ((n.$theme = r.cssClass),
                (n.theme = r),
                ...
                w.isSafari &&
                  n.scroller &&
                  ((n.scroller.style.background = "red"),
                  (n.scroller.style.background = "")));
            }
            var n = this;
            ((this.$themeId = e),
      ...
      ((S.prototype.CHANGE_CURSOR = 1),
        (S.prototype.CHANGE_MARKER = 2),
        (S.prototype.CHANGE_GUTTER = 4),
        (S.prototype.CHANGE_SCROLL = 8),
        (S.prototype.CHANGE_LINES = 16),
        (S.prototype.CHANGE_TEXT = 32),
        (S.prototype.CHANGE_SIZE = 64),
        (S.prototype.CHANGE_MARKER_BACK = 128),
        (S.prototype.CHANGE_MARKER_FRONT = 256),
        (S.prototype.CHANGE_FULL = 512),
        (S.prototype.CHANGE_H_SCROLL = 1024),
        (S.prototype.$changes = 0),
        (S.prototype.$padding = null),
        (S.prototype.$frozen = !1),
        (S.prototype.STEPS = 8),
        r.implement(S.prototype, g),
        o.defineOptions(S.prototype, "renderer", {
          useResizeObserver: {
            set: function (e) {
  ...
  ace.define(
    ...
    ["require", "exports", "module", "ace/lib/dom", "ace/range", "ace/config"],
    function (e, t, n) {
      "use strict";
      function o(e, t, n) {
        var r = 0,
      ...
      function u(e, t, n) {
        ...
        if (!r.length) return;
        var s = o(r, { row: t, column: -1 }, i.comparePoints);
        (s < 0 && (s = -s - 1),
          s >= r.length
            ? (s = n > 0 ? 0 : r.length - 1)
            : s === 0 && n < 0 && (s = r.length - 1));
        var u = r[s];
        if (!u || !n) return;
        if (u.row === t) {
          do u = r[(s += n)];
      ...
      ((t.showErrorMarker = function (e, t) {
        ...
        if (f) {
          ...
          ((i.column =
            ...
            (i.row = c.row),
            (l = e.renderer.$gutterLayer.$annotations[i.row]));
        } else {
          if (a) return;
          l = {
            displayText: [s("error-marker.good-state", "Looks good!")],
            className: "ace_ok",
          };
        }
        ...
        var h = {
          ...
          p = h.el.appendChild(r.createElement("div")),
          d = h.el.appendChild(r.createElement("div"));
        ...
        ((d.style.left = v + e.renderer.gutterWidth - 5 + "px"),
          ...
          l.displayText.forEach(function (e, t) {
            (p.appendChild(r.createTextNode(e)),
              t < l.displayText.length - 1 &&
                p.appendChild(r.createElement("br")));
          }),
